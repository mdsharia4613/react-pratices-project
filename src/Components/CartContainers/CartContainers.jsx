...
const CartContainers = ({ handleIsActiveStstues, isActive, handleDeleteItem, selectedProducts, }) => {
    return (
        <div>
            ...
            {isActive.status === 'cart' ? <Cart handleDeleteItem={handleDeleteItem} selectedProducts={selectedProducts} /> : <About />}
        </div>
    )
}
